...
public class Main {
    ...
    public static String llenguatgesPath = basePath + "bdd\\llenguatges.json";
    public static String einesPath = basePath + "bdd\\eines.json";
    public static String softwarePath = basePath + "bdd\\software.json";
